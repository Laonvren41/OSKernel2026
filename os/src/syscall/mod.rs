...
/// shutdown syscall (OSKernel2026)
pub const SYSCALL_SHUTDOWN: usize = 410;
/// meminfo syscall (OSKernel2026)
pub const SYSCALL_MEMINFO: usize = 411;
/*
/// mail read syscall
...
pub fn syscall(syscall_id: usize, args: [usize; 6]) -> isize {
    ...
    match syscall_id {
        ...
        // OSKernel2026 new syscalls
        SYSCALL_SHUTDOWN => sys_shutdown(args[0]),
        SYSCALL_MEMINFO => sys_meminfo(args[0] as *mut MemInfo),
